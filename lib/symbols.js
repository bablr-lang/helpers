...
const active = Symbol.for('@cst-tokens/statuses/active');
const suspended = Symbol.for('@cst-tokens/statuses/suspended');
const accepted = Symbol.for('@cst-tokens/statuses/accepted');
const rejected = Symbol.for('@cst-tokens/statuses/rejected');
