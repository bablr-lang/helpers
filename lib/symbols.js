...
export const Any = Symbol.for('cst-tokens/any');
export const All = Symbol.for('cst-tokens/all');
...
export const fail = Symbol.for('cst-tokens/fail');
...
export const parent = Symbol.for('cst-tokens/parent');
...
export const boundary = Symbol.for('cst-tokens/boundary');
