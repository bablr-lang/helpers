...
export const eat = (matcher, props, options) => {
  return buildCall(
    ...
    buildTuple(
      buildTupleValues([
        buildExpression(matcher),
        buildExpression(props),
...
export const fail = () => {
  return buildCall(buildIdentifier('fail'), buildTuple(buildTupleValues([])));
};

export const bindAttribute = (key, value) => {
  return buildCall(
    buildIdentifier('bindAttribute'),
    buildTuple(buildTupleValues([buildExpression(key), buildExpression(value)])),
  );
};
...
export const write = (value) => {
  return buildCall(
    ...
    buildTuple(buildTupleValues([buildExpression(value)])),
  );
};
